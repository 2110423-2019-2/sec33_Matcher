...
export const cancelTask = async (taskId: string) => await axios.get(apiEndpointOf(`/task/cancel/${taskId}`), { withCredentials: true });
export const reportTask = (userId: string, reason?: string): Promise<any> =>
    axios.post(apiEndpointOf('/report/create'), { userId, reason }, { withCredentials: true });
