...
const UserCard = ({
    ...
    profilePic = "/images/profile-placeholder.png"
}: UserCardProps) => <div className="row left">
        <div className="col-3">
        ...
        <div className="col-8">
            <div className="row taskHeaderText">
                {name}
            </div>
...
export default ({ name, location, profilePic, price = 0, thumbnail = "/images/horizontal-placeholder.png" }: TaskCardProps) => <div style={{ display: 'inline-flex' }}>
    <div className="taskCardContainer">
        ...
        <div className="row">
            <div className="col-6 left">
                <p className="taskPriceTag">฿ <span className="price">{price}</span> / hr</p>
            </div>
            <div className="col-6">
                <Button>Get</Button>
            </div>
