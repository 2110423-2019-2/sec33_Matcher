...
const ColorDot = ({ color = '#EEE', alt }: any) => (
    <div className="row">
...
export default () => (
    <div className="row center">
        ...
        <div className="row center">
            <div className="col-2">
                <ColorDot color="#00577F" alt="color-primary" />
            </div>
            <div className="col-2">
                <ColorDot color="#F67280" alt="color-secondary" />
            </div>
            <div className="col-2">
                <ColorDot color="#F8B195" alt="color-ternary" />
            </div>
            <div className="col-2">
                <ColorDot color="#C06C84" alt="color-rose" />
            </div>
            <div className="col-2">
                <ColorDot color="#F6F6F6" alt="color-white" />
            </div>
            <div className="col-2">
                <ColorDot color="#555555" alt="color-dark" />
            </div>
        </div>
        <h3>Button</h3>
        <div className="row center">
            ...
            <div className="col-4">
                <Button>
                    Button Icon <Chevron style={{ strokeWidth: 1 }} />
                </Button>
                <br />
                <br />
